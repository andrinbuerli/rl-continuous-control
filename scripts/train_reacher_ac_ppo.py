...
if __name__ == "__main__":
    ...
    get_policy = lambda: ContinuousDiagonalGaussianPolicy(state_size=env.state_size, action_size=env.action_size,
                                                          seed=args.seed, output_transform=lambda x: torch.tanh(x))
    get_value_function = lambda: ValueFunction(state_size=env.state_size, seed=args.seed)
